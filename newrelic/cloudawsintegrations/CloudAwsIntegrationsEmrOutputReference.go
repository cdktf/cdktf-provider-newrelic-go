...
func (c *jsiiProxy_CloudAwsIntegrationsEmrOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAwsIntegrationsEmrOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
