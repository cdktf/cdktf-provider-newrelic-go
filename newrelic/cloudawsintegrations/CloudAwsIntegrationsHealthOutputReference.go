...
type CloudAwsIntegrationsHealthOutputReference interface {
	cdktf.ComplexObject
	...
	// Experimental.
	Fqn() *string
	InternalValue() *CloudAwsIntegrationsHealth
	SetInternalValue(val *CloudAwsIntegrationsHealth)
...
// The jsii proxy struct for CloudAwsIntegrationsHealthOutputReference
type jsiiProxy_CloudAwsIntegrationsHealthOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) InternalValue() *CloudAwsIntegrationsHealth {
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) MetricsPollingInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) MetricsPollingIntervalInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (c *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) ResetMetricsPollingInterval() {
	_jsii_.InvokeVoid(
		c,
		"resetMetricsPollingInterval",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudAwsIntegrationsHealthOutputReference) ToString() *string {
	var returns *string
