...
func (c *jsiiProxy_CloudAwsIntegrationsEcsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAwsIntegrationsEcsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
