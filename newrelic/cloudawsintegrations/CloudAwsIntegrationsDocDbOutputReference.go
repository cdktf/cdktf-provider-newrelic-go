...
func (c *jsiiProxy_CloudAwsIntegrationsDocDbOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAwsIntegrationsDocDbOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
