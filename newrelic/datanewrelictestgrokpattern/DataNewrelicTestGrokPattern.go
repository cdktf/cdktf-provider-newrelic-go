...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.33.0/docs/data-sources/test_grok_pattern newrelic_test_grok_pattern} Data Source.
...
func (d *jsiiProxy_DataNewrelicTestGrokPattern) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataNewrelicTestGrokPattern) ToHclTerraform() interface{} {
	var returns interface{}
