...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.53.0/docs/resources/synthetics_multilocation_alert_condition newrelic_synthetics_multilocation_alert_condition} Resource.
...
func SyntheticsMultilocationAlertCondition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateSyntheticsMultilocationAlertCondition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) MoveFromId(id *string) {
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) MoveToId(id *string) {
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) ResetViolationTimeLimitSeconds() {
	_jsii_.InvokeVoid(
		s,
		"resetViolationTimeLimitSeconds",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsMultilocationAlertCondition) ToHclTerraform() interface{} {
	var returns interface{}
