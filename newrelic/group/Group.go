...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/group/internal"
...
func (j *jsiiProxy_Group) AuthenticationDomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Group) AuthenticationDomainIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.38.1/docs/resources/group newrelic_group} Resource.
...
func (j *jsiiProxy_Group)SetAuthenticationDomainId(val *string) {
