...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lucene", GoGetter: "Lucene"},
			_jsii_.MemberProperty{JsiiProperty: "luceneInput", GoGetter: "LuceneInput"},
			_jsii_.MemberProperty{JsiiProperty: "matched", GoGetter: "Matched"},
			_jsii_.MemberProperty{JsiiProperty: "matchedInput", GoGetter: "MatchedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMatched", GoMethod: "ResetMatched"},
