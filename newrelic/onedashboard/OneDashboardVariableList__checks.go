...
func (o *jsiiProxy_OneDashboardVariableList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (o *jsiiProxy_OneDashboardVariableList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
