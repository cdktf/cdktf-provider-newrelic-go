...
func (j *jsiiProxy_OneDashboardPageWidgetFunnelNrqlQueryOutputReference) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_OneDashboardPageWidgetFunnelNrqlQueryOutputReference) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_OneDashboardPageWidgetFunnelNrqlQueryOutputReference)SetAccountId(val *string) {
...
func (o *jsiiProxy_OneDashboardPageWidgetFunnelNrqlQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OneDashboardPageWidgetFunnelNrqlQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
