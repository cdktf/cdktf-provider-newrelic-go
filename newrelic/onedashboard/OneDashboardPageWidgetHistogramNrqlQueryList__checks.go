...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramNrqlQueryList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramNrqlQueryList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
