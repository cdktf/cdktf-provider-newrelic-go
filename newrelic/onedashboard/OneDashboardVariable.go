...
type OneDashboardVariable struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.72.1/docs/resources/one_dashboard#replacement_strategy OneDashboard#replacement_strategy}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.72.1/docs/resources/one_dashboard#default_values OneDashboard#default_values}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.72.1/docs/resources/one_dashboard#is_multi_selection OneDashboard#is_multi_selection}
	IsMultiSelection interface{} `field:"optional" json:"isMultiSelection" yaml:"isMultiSelection"`
	// item block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.72.1/docs/resources/one_dashboard#item OneDashboard#item}
	...
	// options block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.72.1/docs/resources/one_dashboard#options OneDashboard#options}
