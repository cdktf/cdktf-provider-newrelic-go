...
type OneDashboardPageWidgetStackedBar struct {
	...
	InitialSorting *OneDashboardPageWidgetStackedBarInitialSorting `field:"optional" json:"initialSorting" yaml:"initialSorting"`
	...
	Tooltip *OneDashboardPageWidgetStackedBarTooltip `field:"optional" json:"tooltip" yaml:"tooltip"`
	// units block.
	//
