...
type OneDashboardVariableOptions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.56.0/docs/resources/one_dashboard#excluded OneDashboard#excluded}
