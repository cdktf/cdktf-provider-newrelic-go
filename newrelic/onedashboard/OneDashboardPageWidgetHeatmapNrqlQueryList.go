...
type OneDashboardPageWidgetHeatmapNrqlQueryList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) OneDashboardPageWidgetHeatmapNrqlQueryOutputReference
...
// The jsii proxy struct for OneDashboardPageWidgetHeatmapNrqlQueryList
type jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) InternalValue() interface{} {
...
func (j *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OneDashboardPageWidgetHeatmapNrqlQueryList) ToString() *string {
	var returns *string
