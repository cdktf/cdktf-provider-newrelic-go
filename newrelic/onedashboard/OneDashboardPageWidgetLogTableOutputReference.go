...
type OneDashboardPageWidgetLogTableOutputReference interface {
	...
	DataFormat() OneDashboardPageWidgetLogTableDataFormatList
	...
	InitialSorting() OneDashboardPageWidgetLogTableInitialSortingOutputReference
	InitialSortingInput() *OneDashboardPageWidgetLogTableInitialSorting
	...
	PutInitialSorting(value *OneDashboardPageWidgetLogTableInitialSorting)
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) DataFormat() OneDashboardPageWidgetLogTableDataFormatList {
	var returns OneDashboardPageWidgetLogTableDataFormatList
	_jsii_.Get(
		j,
		"dataFormat",
		&returns,
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) DataFormatInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataFormatInput",
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) InitialSorting() OneDashboardPageWidgetLogTableInitialSortingOutputReference {
	var returns OneDashboardPageWidgetLogTableInitialSortingOutputReference
	_jsii_.Get(
		j,
		"initialSorting",
		&returns,
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) InitialSortingInput() *OneDashboardPageWidgetLogTableInitialSorting {
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) RefreshRate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"refreshRate",
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) RefreshRateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"refreshRateInput",
...
func (j *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference)SetRefreshRate(val *string) {
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) PutDataFormat(value interface{}) {
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) PutInitialSorting(value *OneDashboardPageWidgetLogTableInitialSorting) {
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) ResetDataFormat() {
	_jsii_.InvokeVoid(
		o,
		"resetDataFormat",
		nil, // no parameters
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) ResetInitialSorting() {
	_jsii_.InvokeVoid(
		o,
		"resetInitialSorting",
		nil, // no parameters
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) ResetRefreshRate() {
	_jsii_.InvokeVoid(
		o,
		"resetRefreshRate",
		nil, // no parameters
...
func (o *jsiiProxy_OneDashboardPageWidgetLogTableOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
