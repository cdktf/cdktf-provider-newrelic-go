...
type OneDashboardPageWidgetJsonNrqlQueryList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) OneDashboardPageWidgetJsonNrqlQueryOutputReference
...
// The jsii proxy struct for OneDashboardPageWidgetJsonNrqlQueryList
type jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) InternalValue() interface{} {
...
func (j *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OneDashboardPageWidgetJsonNrqlQueryList) ToString() *string {
	var returns *string
