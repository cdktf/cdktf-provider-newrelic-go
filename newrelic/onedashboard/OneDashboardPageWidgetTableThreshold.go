...
type OneDashboardPageWidgetTableThreshold struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.39.0/docs/resources/one_dashboard#column_name OneDashboard#column_name}
