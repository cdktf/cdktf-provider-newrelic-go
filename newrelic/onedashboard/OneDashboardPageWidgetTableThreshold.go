...
type OneDashboardPageWidgetTableThreshold struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.60.2/docs/resources/one_dashboard#column_name OneDashboard#column_name}
