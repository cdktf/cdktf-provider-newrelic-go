...
type OneDashboardPageList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) OneDashboardPageOutputReference
...
// The jsii proxy struct for OneDashboardPageList
type jsiiProxy_OneDashboardPageList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_OneDashboardPageList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OneDashboardPageList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OneDashboardPageList) InternalValue() interface{} {
...
func (j *jsiiProxy_OneDashboardPageList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OneDashboardPageList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_OneDashboardPageList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_OneDashboardPageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OneDashboardPageList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OneDashboardPageList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OneDashboardPageList) ToString() *string {
	var returns *string
