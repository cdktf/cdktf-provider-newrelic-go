...
func (o *jsiiProxy_OneDashboardPageWidgetAreaList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (o *jsiiProxy_OneDashboardPageWidgetAreaList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
