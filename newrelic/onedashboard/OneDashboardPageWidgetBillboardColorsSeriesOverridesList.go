...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) InternalValue() interface{} {
...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList)SetWrapsSet(val *bool) {
...
func (o *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) Get(index *float64) OneDashboardPageWidgetBillboardColorsSeriesOverridesOutputReference {
	if err := o.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns OneDashboardPageWidgetBillboardColorsSeriesOverridesOutputReference
...
func (o *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OneDashboardPageWidgetBillboardColorsSeriesOverridesList) ToString() *string {
	var returns *string
