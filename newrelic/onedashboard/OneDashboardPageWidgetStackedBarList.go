...
type OneDashboardPageWidgetStackedBarList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) OneDashboardPageWidgetStackedBarOutputReference
...
// The jsii proxy struct for OneDashboardPageWidgetStackedBarList
type jsiiProxy_OneDashboardPageWidgetStackedBarList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_OneDashboardPageWidgetStackedBarList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OneDashboardPageWidgetStackedBarList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OneDashboardPageWidgetStackedBarList) InternalValue() interface{} {
...
func (j *jsiiProxy_OneDashboardPageWidgetStackedBarList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OneDashboardPageWidgetStackedBarList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_OneDashboardPageWidgetStackedBarList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_OneDashboardPageWidgetStackedBarList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OneDashboardPageWidgetStackedBarList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OneDashboardPageWidgetStackedBarList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OneDashboardPageWidgetStackedBarList) ToString() *string {
	var returns *string
