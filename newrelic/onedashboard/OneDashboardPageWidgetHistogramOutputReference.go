...
type OneDashboardPageWidgetHistogramOutputReference interface {
	...
	DataFormat() OneDashboardPageWidgetHistogramDataFormatList
	...
	InitialSorting() OneDashboardPageWidgetHistogramInitialSortingOutputReference
	InitialSortingInput() *OneDashboardPageWidgetHistogramInitialSorting
	...
	PutInitialSorting(value *OneDashboardPageWidgetHistogramInitialSorting)
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) DataFormat() OneDashboardPageWidgetHistogramDataFormatList {
	var returns OneDashboardPageWidgetHistogramDataFormatList
	_jsii_.Get(
		j,
		"dataFormat",
		&returns,
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) DataFormatInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataFormatInput",
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) InitialSorting() OneDashboardPageWidgetHistogramInitialSortingOutputReference {
	var returns OneDashboardPageWidgetHistogramInitialSortingOutputReference
	_jsii_.Get(
		j,
		"initialSorting",
		&returns,
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) InitialSortingInput() *OneDashboardPageWidgetHistogramInitialSorting {
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) RefreshRate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"refreshRate",
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) RefreshRateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"refreshRateInput",
...
func (j *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference)SetRefreshRate(val *string) {
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) PutDataFormat(value interface{}) {
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) PutInitialSorting(value *OneDashboardPageWidgetHistogramInitialSorting) {
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) ResetDataFormat() {
	_jsii_.InvokeVoid(
		o,
		"resetDataFormat",
		nil, // no parameters
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) ResetInitialSorting() {
	_jsii_.InvokeVoid(
		o,
		"resetInitialSorting",
		nil, // no parameters
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) ResetRefreshRate() {
	_jsii_.InvokeVoid(
		o,
		"resetRefreshRate",
		nil, // no parameters
...
func (o *jsiiProxy_OneDashboardPageWidgetHistogramOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
