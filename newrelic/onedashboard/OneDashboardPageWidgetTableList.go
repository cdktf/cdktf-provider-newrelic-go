...
type OneDashboardPageWidgetTableList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) OneDashboardPageWidgetTableOutputReference
...
// The jsii proxy struct for OneDashboardPageWidgetTableList
type jsiiProxy_OneDashboardPageWidgetTableList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_OneDashboardPageWidgetTableList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OneDashboardPageWidgetTableList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OneDashboardPageWidgetTableList) InternalValue() interface{} {
...
func (j *jsiiProxy_OneDashboardPageWidgetTableList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OneDashboardPageWidgetTableList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_OneDashboardPageWidgetTableList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_OneDashboardPageWidgetTableList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OneDashboardPageWidgetTableList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OneDashboardPageWidgetTableList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OneDashboardPageWidgetTableList) ToString() *string {
	var returns *string
