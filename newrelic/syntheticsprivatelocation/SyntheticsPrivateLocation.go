...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/syntheticsprivatelocation/internal"
...
func (j *jsiiProxy_SyntheticsPrivateLocation) AccountIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) DomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainId",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Guid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"guid",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) LocationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationId",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) VerifiedScriptExecution() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsPrivateLocation) VerifiedScriptExecutionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"verifiedScriptExecutionInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.47.0/docs/resources/synthetics_private_location newrelic_synthetics_private_location} Resource.
...
func (j *jsiiProxy_SyntheticsPrivateLocation)SetAccountId(val *float64) {
...
func (j *jsiiProxy_SyntheticsPrivateLocation)SetVerifiedScriptExecution(val interface{}) {
	if err := j.validateSetVerifiedScriptExecutionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ResetAccountId() {
	_jsii_.InvokeVoid(
		s,
		"resetAccountId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ResetVerifiedScriptExecution() {
	_jsii_.InvokeVoid(
		s,
		"resetVerifiedScriptExecution",
		nil, // no parameters
