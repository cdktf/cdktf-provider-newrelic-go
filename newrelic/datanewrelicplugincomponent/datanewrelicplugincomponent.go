...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-newrelic.dataNewrelicPluginComponent.DataNewrelicPluginComponent",
		reflect.TypeOf((*DataNewrelicPluginComponent)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-newrelic.dataNewrelicPluginComponent.DataNewrelicPluginComponentConfig",
		reflect.TypeOf((*DataNewrelicPluginComponentConfig)(nil)).Elem(),
	)
}
