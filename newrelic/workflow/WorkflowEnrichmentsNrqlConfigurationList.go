...
func (w *jsiiProxy_WorkflowEnrichmentsNrqlConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkflowEnrichmentsNrqlConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
