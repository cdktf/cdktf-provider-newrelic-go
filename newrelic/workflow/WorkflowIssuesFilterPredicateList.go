...
func (w *jsiiProxy_WorkflowIssuesFilterPredicateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkflowIssuesFilterPredicateList) Resolve(context cdktf.IResolveContext) interface{} {
