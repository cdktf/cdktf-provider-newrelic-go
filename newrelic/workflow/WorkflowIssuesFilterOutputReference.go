...
func (j *jsiiProxy_WorkflowIssuesFilterOutputReference) Predicate() WorkflowIssuesFilterPredicateList {
	var returns WorkflowIssuesFilterPredicateList
	_jsii_.Get(
		j,
		"predicate",
		&returns,
...
func (j *jsiiProxy_WorkflowIssuesFilterOutputReference) PredicateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"predicateInput",
...
func (w *jsiiProxy_WorkflowIssuesFilterOutputReference) PutPredicate(value interface{}) {
...
func (w *jsiiProxy_WorkflowIssuesFilterOutputReference) ResetPredicate() {
	_jsii_.InvokeVoid(
		w,
		"resetPredicate",
		nil, // no parameters
