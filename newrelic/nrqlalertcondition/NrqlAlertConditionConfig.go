...
type NrqlAlertConditionConfig struct {
	...
	OutlierConfiguration *NrqlAlertConditionOutlierConfiguration `field:"optional" json:"outlierConfiguration" yaml:"outlierConfiguration"`
	...
	TargetEntity *string `field:"optional" json:"targetEntity" yaml:"targetEntity"`
	// term block.
	//
