...
func (n *jsiiProxy_NrqlAlertConditionTermOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NrqlAlertConditionTermOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
