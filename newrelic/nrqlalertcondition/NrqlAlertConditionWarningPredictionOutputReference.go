...
func (n *jsiiProxy_NrqlAlertConditionWarningPredictionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NrqlAlertConditionWarningPredictionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
