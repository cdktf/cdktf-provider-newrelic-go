...
func (j *jsiiProxy_CloudGcpIntegrations) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CloudGcpIntegrations)SetCount(val interface{}) {
...
func CloudGcpIntegrations_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateCloudGcpIntegrations_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CloudGcpIntegrations_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateCloudGcpIntegrations_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudGcpIntegrations) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudGcpIntegrations) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudGcpIntegrations) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudGcpIntegrations) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudGcpIntegrations) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudGcpIntegrations) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudGcpIntegrations) ToHclTerraform() interface{} {
	var returns interface{}
