...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/cloudawsgovcloudlinkaccount/internal"
...
func (j *jsiiProxy_CloudAwsGovcloudLinkAccount) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.37.1/docs/resources/cloud_aws_govcloud_link_account newrelic_cloud_aws_govcloud_link_account} Resource.
...
func (j *jsiiProxy_CloudAwsGovcloudLinkAccount)SetCount(val interface{}) {
...
func CloudAwsGovcloudLinkAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudAwsGovcloudLinkAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func CloudAwsGovcloudLinkAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudAwsGovcloudLinkAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudAwsGovcloudLinkAccount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudAwsGovcloudLinkAccount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudAwsGovcloudLinkAccount) ToHclTerraform() interface{} {
	var returns interface{}
