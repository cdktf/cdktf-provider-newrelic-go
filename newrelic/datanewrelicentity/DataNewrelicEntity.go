...
func (j *jsiiProxy_DataNewrelicEntity) Count() interface{} {
...
func (j *jsiiProxy_DataNewrelicEntity)SetCount(val interface{}) {
...
func (d *jsiiProxy_DataNewrelicEntity) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataNewrelicEntity) ToHclTerraform() interface{} {
	var returns interface{}
