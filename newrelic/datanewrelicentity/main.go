...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "entityTags", GoGetter: "EntityTags"},
			_jsii_.MemberProperty{JsiiProperty: "entityTagsInput", GoGetter: "EntityTagsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ignoreNotFound", GoGetter: "IgnoreNotFound"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreNotFoundInput", GoGetter: "IgnoreNotFoundInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEntityTags", GoMethod: "ResetEntityTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreCase", GoMethod: "ResetIgnoreCase"},
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreNotFound", GoMethod: "ResetIgnoreNotFound"},
