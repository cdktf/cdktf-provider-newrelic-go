...
type DataNewrelicEntity interface {
	...
	Tag() DataNewrelicEntityTagOutputReference
	TagInput() *DataNewrelicEntityTag
	// Experimental.
	...
	PutTag(value *DataNewrelicEntityTag)
	ResetDomain()
	ResetId()
	ResetIgnoreCase()
...
func (j *jsiiProxy_DataNewrelicEntity) Tag() DataNewrelicEntityTagOutputReference {
...
func (j *jsiiProxy_DataNewrelicEntity) TagInput() *DataNewrelicEntityTag {
...
func (d *jsiiProxy_DataNewrelicEntity) PutTag(value *DataNewrelicEntityTag) {
