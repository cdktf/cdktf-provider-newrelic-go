...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/user/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.58.1/docs/resources/user newrelic_user}.
type User interface {
...
func (j *jsiiProxy_User) AuthenticationDomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_User) AuthenticationDomainIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_User) EmailId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailId",
...
func (j *jsiiProxy_User) EmailIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.58.1/docs/resources/user newrelic_user} Resource.
...
func (j *jsiiProxy_User)SetAuthenticationDomainId(val *string) {
...
func (j *jsiiProxy_User)SetEmailId(val *string) {
