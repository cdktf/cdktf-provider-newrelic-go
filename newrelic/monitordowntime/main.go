...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maintenanceDays", GoGetter: "MaintenanceDays"},
			_jsii_.MemberProperty{JsiiProperty: "maintenanceDaysInput", GoGetter: "MaintenanceDaysInput"},
			_jsii_.MemberProperty{JsiiProperty: "mode", GoGetter: "Mode"},
			_jsii_.MemberProperty{JsiiProperty: "modeInput", GoGetter: "ModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "monitorGuids", GoGetter: "MonitorGuids"},
			_jsii_.MemberProperty{JsiiProperty: "monitorGuidsInput", GoGetter: "MonitorGuidsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putEndRepeat", GoMethod: "PutEndRepeat"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaintenanceDays", GoMethod: "ResetMaintenanceDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetMonitorGuids", GoMethod: "ResetMonitorGuids"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "onDate", GoGetter: "OnDate"},
			_jsii_.MemberProperty{JsiiProperty: "onDateInput", GoGetter: "OnDateInput"},
			_jsii_.MemberProperty{JsiiProperty: "onRepeat", GoGetter: "OnRepeat"},
			_jsii_.MemberProperty{JsiiProperty: "onRepeatInput", GoGetter: "OnRepeatInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetOnDate", GoMethod: "ResetOnDate"},
			_jsii_.MemberMethod{JsiiMethod: "resetOnRepeat", GoMethod: "ResetOnRepeat"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ordinalDayOfMonth", GoGetter: "OrdinalDayOfMonth"},
			_jsii_.MemberProperty{JsiiProperty: "ordinalDayOfMonthInput", GoGetter: "OrdinalDayOfMonthInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
