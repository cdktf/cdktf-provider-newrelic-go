...
func (m *jsiiProxy_MonitorDowntimeEndRepeatOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorDowntimeEndRepeatOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
