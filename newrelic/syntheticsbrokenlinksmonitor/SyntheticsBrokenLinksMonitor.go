...
// Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.61.3/docs/resources/synthetics_broken_links_monitor newrelic_synthetics_broken_links_monitor}.
...
func (j *jsiiProxy_SyntheticsBrokenLinksMonitor) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SyntheticsBrokenLinksMonitor) MonitorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"monitorId",
...
func (j *jsiiProxy_SyntheticsBrokenLinksMonitor) UseUnsupportedLegacyRuntime() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsBrokenLinksMonitor) UseUnsupportedLegacyRuntimeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.61.3/docs/resources/synthetics_broken_links_monitor newrelic_synthetics_broken_links_monitor} Resource.
func NewSyntheticsBrokenLinksMonitor(scope constructs.Construct, id *string, config *SyntheticsBrokenLinksMonitorConfig) SyntheticsBrokenLinksMonitor {
	...
	if err := validateNewSyntheticsBrokenLinksMonitorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SyntheticsBrokenLinksMonitor)SetCount(val interface{}) {
...
func (j *jsiiProxy_SyntheticsBrokenLinksMonitor)SetUseUnsupportedLegacyRuntime(val interface{}) {
...
func SyntheticsBrokenLinksMonitor_IsConstruct(x interface{}) *bool {
	...
	if err := validateSyntheticsBrokenLinksMonitor_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SyntheticsBrokenLinksMonitor_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSyntheticsBrokenLinksMonitor_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SyntheticsBrokenLinksMonitor_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSyntheticsBrokenLinksMonitor_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SyntheticsBrokenLinksMonitor) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsBrokenLinksMonitor) MoveFromId(id *string) {
...
func (s *jsiiProxy_SyntheticsBrokenLinksMonitor) MoveToId(id *string) {
...
func (s *jsiiProxy_SyntheticsBrokenLinksMonitor) ResetUseUnsupportedLegacyRuntime() {
	_jsii_.InvokeVoid(
		s,
		"resetUseUnsupportedLegacyRuntime",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsBrokenLinksMonitor) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsBrokenLinksMonitor) ToHclTerraform() interface{} {
	var returns interface{}
