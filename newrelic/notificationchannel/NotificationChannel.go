...
func (j *jsiiProxy_NotificationChannel) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NotificationChannel)SetCount(val interface{}) {
...
func NotificationChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNotificationChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func NotificationChannel_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNotificationChannel_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NotificationChannel_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNotificationChannel_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (n *jsiiProxy_NotificationChannel) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NotificationChannel) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NotificationChannel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NotificationChannel) MoveFromId(id *string) {
...
func (n *jsiiProxy_NotificationChannel) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NotificationChannel) MoveToId(id *string) {
...
func (n *jsiiProxy_NotificationChannel) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NotificationChannel) ToHclTerraform() interface{} {
	var returns interface{}
