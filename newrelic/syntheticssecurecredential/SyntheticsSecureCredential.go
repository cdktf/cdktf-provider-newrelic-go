...
func (j *jsiiProxy_SyntheticsSecureCredential) Connection() interface{} {
...
func (j *jsiiProxy_SyntheticsSecureCredential) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_SyntheticsSecureCredential) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SyntheticsSecureCredential) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SyntheticsSecureCredential) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_SyntheticsSecureCredential) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_SyntheticsSecureCredential) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SyntheticsSecureCredential) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SyntheticsSecureCredential) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SyntheticsSecureCredential) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SyntheticsSecureCredential) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_SyntheticsSecureCredential) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_SyntheticsSecureCredential) LastUpdated() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdated",
...
func (j *jsiiProxy_SyntheticsSecureCredential) LastUpdatedInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdatedInput",
...
func (j *jsiiProxy_SyntheticsSecureCredential) Node() constructs.Node {
...
func (j *jsiiProxy_SyntheticsSecureCredential) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SyntheticsSecureCredential) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_SyntheticsSecureCredential) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsSecureCredential) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsSecureCredential) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_SyntheticsSecureCredential) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.36.1/docs/resources/synthetics_secure_credential newrelic_synthetics_secure_credential} Resource.
...
func (j *jsiiProxy_SyntheticsSecureCredential)SetCount(val interface{}) {
...
func SyntheticsSecureCredential_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateSyntheticsSecureCredential_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SyntheticsSecureCredential_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateSyntheticsSecureCredential_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SyntheticsSecureCredential) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsSecureCredential) MoveFromId(id *string) {
...
func (s *jsiiProxy_SyntheticsSecureCredential) MoveToId(id *string) {
...
func (s *jsiiProxy_SyntheticsSecureCredential) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsSecureCredential) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsSecureCredential) ResetLastUpdated() {
	_jsii_.InvokeVoid(
		s,
		"resetLastUpdated",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsSecureCredential) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsSecureCredential) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsSecureCredential) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsSecureCredential) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsSecureCredential) ToMetadata() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsSecureCredential) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SyntheticsSecureCredential) ToTerraform() interface{} {
	var returns interface{}
