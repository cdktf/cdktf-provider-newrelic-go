...
import (
	...
	"github.com/hashicorp/cdktf-provider-newrelic-go/newrelic/v3/alertpolicy/internal"
...
func (j *jsiiProxy_AlertPolicy) AccountId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_AlertPolicy) AccountIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_AlertPolicy) ChannelIds() *[]*float64 {
	var returns *[]*float64
	_jsii_.Get(
		j,
		"channelIds",
...
func (j *jsiiProxy_AlertPolicy) ChannelIdsInput() *[]*float64 {
	var returns *[]*float64
	_jsii_.Get(
		j,
		"channelIdsInput",
...
func (j *jsiiProxy_AlertPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AlertPolicy) IncidentPreference() *string {
	var returns *string
	_jsii_.Get(
		j,
		"incidentPreference",
...
func (j *jsiiProxy_AlertPolicy) IncidentPreferenceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AlertPolicy)SetAccountId(val *float64) {
...
func (j *jsiiProxy_AlertPolicy)SetChannelIds(val *[]*float64) {
...
func (j *jsiiProxy_AlertPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_AlertPolicy)SetIncidentPreference(val *string) {
...
func (a *jsiiProxy_AlertPolicy) ResetAccountId() {
	_jsii_.InvokeVoid(
		a,
		"resetAccountId",
		nil, // no parameters
...
func (a *jsiiProxy_AlertPolicy) ResetChannelIds() {
	_jsii_.InvokeVoid(
		a,
		"resetChannelIds",
		nil, // no parameters
...
func (a *jsiiProxy_AlertPolicy) ResetIncidentPreference() {
	_jsii_.InvokeVoid(
		a,
		"resetIncidentPreference",
		nil, // no parameters
