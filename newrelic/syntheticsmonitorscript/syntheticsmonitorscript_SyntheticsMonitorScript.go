...
import (
	...
	"github.com/hashicorp/cdktf-provider-newrelic-go/newrelic/v3/syntheticsmonitorscript/internal"
...
type SyntheticsMonitorScript interface {
	...
	Location() SyntheticsMonitorScriptLocationList
...
// The jsii proxy struct for SyntheticsMonitorScript
type jsiiProxy_SyntheticsMonitorScript struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_SyntheticsMonitorScript) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SyntheticsMonitorScript) Connection() interface{} {
...
func (j *jsiiProxy_SyntheticsMonitorScript) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_SyntheticsMonitorScript) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SyntheticsMonitorScript) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SyntheticsMonitorScript) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SyntheticsMonitorScript) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SyntheticsMonitorScript) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SyntheticsMonitorScript) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SyntheticsMonitorScript) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SyntheticsMonitorScript) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SyntheticsMonitorScript) Location() SyntheticsMonitorScriptLocationList {
	var returns SyntheticsMonitorScriptLocationList
	_jsii_.Get(
		j,
		"location",
		&returns,
...
func (j *jsiiProxy_SyntheticsMonitorScript) LocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_SyntheticsMonitorScript) MonitorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"monitorId",
...
func (j *jsiiProxy_SyntheticsMonitorScript) MonitorIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"monitorIdInput",
...
func (j *jsiiProxy_SyntheticsMonitorScript) Node() constructs.Node {
...
func (j *jsiiProxy_SyntheticsMonitorScript) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SyntheticsMonitorScript) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SyntheticsMonitorScript) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_SyntheticsMonitorScript) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SyntheticsMonitorScript) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsMonitorScript) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsMonitorScript) Text() *string {
	var returns *string
	_jsii_.Get(
		j,
		"text",
...
func (j *jsiiProxy_SyntheticsMonitorScript) TextInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"textInput",
...
func NewSyntheticsMonitorScript(scope constructs.Construct, id *string, config *SyntheticsMonitorScriptConfig) SyntheticsMonitorScript {
	...
	_jsii_.Create(
		"@cdktf/provider-newrelic.syntheticsMonitorScript.SyntheticsMonitorScript",
...
func (s *jsiiProxy_SyntheticsMonitorScript) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsMonitorScript) ResetLocation() {
	_jsii_.InvokeVoid(
		s,
		"resetLocation",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsMonitorScript) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsMonitorScript) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsMonitorScript) ToMetadata() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsMonitorScript) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SyntheticsMonitorScript) ToTerraform() interface{} {
	var returns interface{}
