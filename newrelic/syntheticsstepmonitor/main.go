...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "browsersInput", GoGetter: "BrowsersInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "locationPrivate", GoGetter: "LocationPrivate"},
			_jsii_.MemberProperty{JsiiProperty: "locationPrivateInput", GoGetter: "LocationPrivateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putLocationPrivate", GoMethod: "PutLocationPrivate"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBrowsers", GoMethod: "ResetBrowsers"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocationPrivate", GoMethod: "ResetLocationPrivate"},
