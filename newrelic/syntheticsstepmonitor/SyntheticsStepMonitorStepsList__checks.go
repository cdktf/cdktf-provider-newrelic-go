...
func (s *jsiiProxy_SyntheticsStepMonitorStepsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
