...
func (s *jsiiProxy_SyntheticsStepMonitorTagList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SyntheticsStepMonitorTagList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
