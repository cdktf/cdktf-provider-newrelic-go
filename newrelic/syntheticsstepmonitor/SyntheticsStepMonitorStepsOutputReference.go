...
func NewSyntheticsStepMonitorStepsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SyntheticsStepMonitorStepsOutputReference {
	...
	if err := validateNewSyntheticsStepMonitorStepsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SyntheticsStepMonitorStepsOutputReference)SetOrdinal(val *float64) {
	if err := j.validateSetOrdinalParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
