...
func (d *jsiiProxy_DataNewrelicNotificationDestinationPropertyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataNewrelicNotificationDestinationPropertyList) Resolve(context cdktf.IResolveContext) interface{} {
