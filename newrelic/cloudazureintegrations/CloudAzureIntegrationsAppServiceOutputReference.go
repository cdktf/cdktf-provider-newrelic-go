...
func NewCloudAzureIntegrationsAppServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudAzureIntegrationsAppServiceOutputReference {
	...
	if err := validateNewCloudAzureIntegrationsAppServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudAzureIntegrationsAppServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAzureIntegrationsAppServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
