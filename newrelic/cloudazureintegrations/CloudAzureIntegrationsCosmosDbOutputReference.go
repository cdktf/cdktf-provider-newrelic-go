...
func NewCloudAzureIntegrationsCosmosDbOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudAzureIntegrationsCosmosDbOutputReference {
	...
	if err := validateNewCloudAzureIntegrationsCosmosDbOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudAzureIntegrationsCosmosDbOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAzureIntegrationsCosmosDbOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
