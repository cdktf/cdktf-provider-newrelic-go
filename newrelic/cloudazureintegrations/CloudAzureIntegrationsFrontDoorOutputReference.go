...
func NewCloudAzureIntegrationsFrontDoorOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudAzureIntegrationsFrontDoorOutputReference {
	...
	if err := validateNewCloudAzureIntegrationsFrontDoorOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudAzureIntegrationsFrontDoorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAzureIntegrationsFrontDoorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
