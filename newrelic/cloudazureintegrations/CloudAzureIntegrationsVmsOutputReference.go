...
func (c *jsiiProxy_CloudAzureIntegrationsVmsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAzureIntegrationsVmsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
