...
type CloudAzureIntegrationsMariaDbOutputReference interface {
	cdktf.ComplexObject
	...
	// Experimental.
	Fqn() *string
	InternalValue() *CloudAzureIntegrationsMariaDb
	SetInternalValue(val *CloudAzureIntegrationsMariaDb)
...
// The jsii proxy struct for CloudAzureIntegrationsMariaDbOutputReference
type jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) InternalValue() *CloudAzureIntegrationsMariaDb {
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) MetricsPollingInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) MetricsPollingIntervalInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ResourceGroups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceGroups",
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ResourceGroupsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceGroupsInput",
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ResetMetricsPollingInterval() {
	_jsii_.InvokeVoid(
		c,
		"resetMetricsPollingInterval",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ResetResourceGroups() {
	_jsii_.InvokeVoid(
		c,
		"resetResourceGroups",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudAzureIntegrationsMariaDbOutputReference) ToString() *string {
	var returns *string
