...
func (s *jsiiProxy_SyntheticsScriptMonitorTagList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SyntheticsScriptMonitorTagList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
