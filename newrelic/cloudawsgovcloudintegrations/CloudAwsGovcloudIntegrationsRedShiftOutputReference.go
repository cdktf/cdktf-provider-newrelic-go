...
type CloudAwsGovcloudIntegrationsRedShiftOutputReference interface {
	cdktf.ComplexObject
	AwsRegions() *[]*string
	...
	// Experimental.
	Fqn() *string
	InternalValue() *CloudAwsGovcloudIntegrationsRedShift
	SetInternalValue(val *CloudAwsGovcloudIntegrationsRedShift)
...
// The jsii proxy struct for CloudAwsGovcloudIntegrationsRedShiftOutputReference
type jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) AwsRegions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"awsRegions",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) AwsRegionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"awsRegionsInput",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) InternalValue() *CloudAwsGovcloudIntegrationsRedShift {
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) MetricsPollingInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) MetricsPollingIntervalInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) TagKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagKey",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) TagKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagKeyInput",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) TagValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagValue",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) TagValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagValueInput",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ResetAwsRegions() {
	_jsii_.InvokeVoid(
		c,
		"resetAwsRegions",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ResetMetricsPollingInterval() {
	_jsii_.InvokeVoid(
		c,
		"resetMetricsPollingInterval",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ResetTagKey() {
	_jsii_.InvokeVoid(
		c,
		"resetTagKey",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ResetTagValue() {
	_jsii_.InvokeVoid(
		c,
		"resetTagValue",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrationsRedShiftOutputReference) ToString() *string {
	var returns *string
