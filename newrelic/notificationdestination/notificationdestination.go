...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-newrelic.notificationDestination.NotificationDestinationProperties",
		reflect.TypeOf((*NotificationDestinationProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-newrelic.notificationDestination.NotificationDestinationPropertiesList",
		reflect.TypeOf((*NotificationDestinationPropertiesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NotificationDestinationPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
