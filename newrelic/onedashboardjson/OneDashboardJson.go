...
func (j *jsiiProxy_OneDashboardJson) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_OneDashboardJson)SetCount(val interface{}) {
...
func (o *jsiiProxy_OneDashboardJson) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OneDashboardJson) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OneDashboardJson) MoveFromId(id *string) {
...
func (o *jsiiProxy_OneDashboardJson) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OneDashboardJson) MoveToId(id *string) {
...
func (o *jsiiProxy_OneDashboardJson) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OneDashboardJson) ToHclTerraform() interface{} {
	var returns interface{}
