...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/datanewrelickeytransaction/internal"
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) AccountIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) Node() constructs.Node {
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataNewrelicKeyTransaction) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataNewrelicKeyTransaction)SetAccountId(val *float64) {
...
// Experimental.
func DataNewrelicKeyTransaction_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataNewrelicKeyTransaction_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataNewrelicKeyTransaction_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataNewrelicKeyTransaction_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ResetAccountId() {
	_jsii_.InvokeVoid(
		d,
		"resetAccountId",
		nil, // no parameters
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataNewrelicKeyTransaction) ToTerraform() interface{} {
	var returns interface{}
