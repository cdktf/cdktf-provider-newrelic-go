...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/cloudazurelinkaccount/internal"
...
func (j *jsiiProxy_CloudAzureLinkAccount) AccountIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_CloudAzureLinkAccount) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) ClientSecret() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientSecret",
...
func (j *jsiiProxy_CloudAzureLinkAccount) ClientSecretInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientSecretInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) Connection() interface{} {
...
func (j *jsiiProxy_CloudAzureLinkAccount) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_CloudAzureLinkAccount) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CloudAzureLinkAccount) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CloudAzureLinkAccount) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudAzureLinkAccount) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CloudAzureLinkAccount) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CloudAzureLinkAccount) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CloudAzureLinkAccount) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) Node() constructs.Node {
...
func (j *jsiiProxy_CloudAzureLinkAccount) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_CloudAzureLinkAccount) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_CloudAzureLinkAccount) SubscriptionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionId",
...
func (j *jsiiProxy_CloudAzureLinkAccount) SubscriptionIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionIdInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) TenantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tenantId",
...
func (j *jsiiProxy_CloudAzureLinkAccount) TenantIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tenantIdInput",
...
func (j *jsiiProxy_CloudAzureLinkAccount) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAzureLinkAccount) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudAzureLinkAccount)SetCount(val interface{}) {
...
// Experimental.
func CloudAzureLinkAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudAzureLinkAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudAzureLinkAccount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudAzureLinkAccount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudAzureLinkAccount) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudAzureLinkAccount) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudAzureLinkAccount) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudAzureLinkAccount) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudAzureLinkAccount) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudAzureLinkAccount) ResetAccountId() {
	_jsii_.InvokeVoid(
		c,
		"resetAccountId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAzureLinkAccount) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAzureLinkAccount) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAzureLinkAccount) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudAzureLinkAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudAzureLinkAccount) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudAzureLinkAccount) ToMetadata() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudAzureLinkAccount) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CloudAzureLinkAccount) ToTerraform() interface{} {
	var returns interface{}
