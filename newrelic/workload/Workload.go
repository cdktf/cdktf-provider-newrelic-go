...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.60.0/docs/resources/workload newrelic_workload} Resource.
...
func Workload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWorkload_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_Workload) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_Workload) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_Workload) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_Workload) MoveFromId(id *string) {
...
func (w *jsiiProxy_Workload) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_Workload) MoveToId(id *string) {
...
func (w *jsiiProxy_Workload) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_Workload) ToHclTerraform() interface{} {
	var returns interface{}
