...
func (s *jsiiProxy_SyntheticsCertCheckMonitorTagList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SyntheticsCertCheckMonitorTagList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
