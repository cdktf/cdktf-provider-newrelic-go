...
import (
	...
	"github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v12/datanewrelicobfuscationexpression/internal"
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.33.0/docs/data-sources/obfuscation_expression newrelic_obfuscation_expression} Data Source.
...
func DataNewrelicObfuscationExpression_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataNewrelicObfuscationExpression_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataNewrelicObfuscationExpression) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataNewrelicObfuscationExpression) ToHclTerraform() interface{} {
	var returns interface{}
