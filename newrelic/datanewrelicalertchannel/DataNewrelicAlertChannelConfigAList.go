...
type DataNewrelicAlertChannelConfigAList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DataNewrelicAlertChannelConfigAOutputReference
...
// The jsii proxy struct for DataNewrelicAlertChannelConfigAList
type jsiiProxy_DataNewrelicAlertChannelConfigAList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataNewrelicAlertChannelConfigAList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataNewrelicAlertChannelConfigAList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataNewrelicAlertChannelConfigAList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataNewrelicAlertChannelConfigAList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataNewrelicAlertChannelConfigAList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataNewrelicAlertChannelConfigAList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataNewrelicAlertChannelConfigAList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataNewrelicAlertChannelConfigAList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataNewrelicAlertChannelConfigAList) ToString() *string {
	var returns *string
