...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "targetDataPartition", GoGetter: "TargetDataPartition"},
			_jsii_.MemberProperty{JsiiProperty: "targetDataPartitionInput", GoGetter: "TargetDataPartitionInput"},
